...
def sweep_taskagnostic(ASI_type: type[hotspin.Magnets], variables: dict = None, save=True, **constants):
    ...
    for index, _ in np.ndenumerate(np.zeros(n_per_var)): # Sweep across the hypercube of variables
        ...
        data_i = hotspin.utils.Data.load(single_taskagnostic(experiment, **kwargs))
        df_i = data_i.df
...
if __name__ == "__main__":
    ...
    # load_sweep_to_experiments(hotspin.utils.Data.load("results/TaskAgnosticExperiment/Sweep/n,T_20220517162856.json"))
