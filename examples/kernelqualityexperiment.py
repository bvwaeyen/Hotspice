...
def plot2Dsweep(summary_file, save=True, plot=True, col_x=None, col_y=None, name_x=None, name_y=None, transform_x=None, transform_y=None):
    ...
    ## HERE BEGINS THE PLOTTING CODE WHICH IS EXTRAORDINARILY LONG AS COMPARED TO THE DATA EXTRACTION CODE AS IS UNDERSTANDABLE CONSIDERING A GUI REQUIRES A LOT OF INFORMATION TO BE DISPLAYED CORRECTLY HENCE THE INSANE AMOUNT OF CODE BELOW
    ...
    plt.suptitle(f'K, G and Q sweep')
...
if __name__ == "__main__":
    plot2Dsweep("results/Sweeps/Sweep_RC_ASI_sweep256_out50_in10.json",
