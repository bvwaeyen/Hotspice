...
# Diego made this class (DiMonopolarEnergy)
class DiMonopolarEnergy(Energy):
    def __init__(self, prefactor=1, d=200e-9, small_d=200e-9):
        """ This DimonopolarEnergy class implements the interaction between the magnets of the simulation themselves using the monopole approximation.
            ...
            @param d [float] (2): The distance between two monopoles in one magnet in meters
        """
        self._prefactor = prefactor
        self.d = d  # [m]
...
class ExchangeEnergy(
    Energy):  # TODO: allow random variation in J, see https://stackoverflow.com/a/73398072 for this kind of convolution
